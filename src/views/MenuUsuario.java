...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		JPanel btnSalirSistema = new JPanel();
		btnSalirSistema.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnSalirSistema.setBackground(new Color(118, 187, 223));				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnSalirSistema.setBackground(new Color(12, 138, 199));	
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		btnSalirSistema.setLayout(null);
		btnSalirSistema.setBackground(new Color(12, 138, 199));
		btnSalirSistema.setBounds(0, 369, 257, 56);
		panelMenu.add(btnSalirSistema);
		
		JLabel lblSalirDelSistem = new JLabel("Salir del Sistema");
		lblSalirDelSistem.setIcon(null);
		lblSalirDelSistem.setHorizontalAlignment(SwingConstants.LEFT);
		lblSalirDelSistem.setForeground(Color.WHITE);
		lblSalirDelSistem.setFont(new Font("Dialog", Font.PLAIN, 18));
		lblSalirDelSistem.setBounds(27, 11, 200, 34);
		btnSalirSistema.add(lblSalirDelSistem);
