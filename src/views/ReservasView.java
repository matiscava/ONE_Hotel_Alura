...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblCheckIn.setBounds(68, 136, 229, 14);
		lblCheckIn.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblCheckIn);
		
		JLabel lblCheckOut = new JLabel("FECHA DE CHECK OUT");
		lblCheckOut.setForeground(SystemColor.textInactiveText);
		lblCheckOut.setBounds(68, 221, 229, 14);
		...
		lblValor.setBounds(72, 303, 241, 14);
	...
	public void calcularValor(JDateChooser fechaEntrada, JDateChooser fechaSalida) {
		if(fechaEntrada.getDate() != null && fechaSalida.getDate() != null) {
			...
			int dias = -1;
			int noche = 500; //valor de estadia x noche
			int valor;
